...
const CourseDetailsArea:FC<CourseDataSingle> = ({course}) => {
                     ...
                     <div className="course-details-content mb-45">
                        <div className="tpcourse__category mb-15">
                           <ul className="tpcourse__price-list d-flex align-items-center">
                              <li><a className={course.cn_color} href="#">{course.title}</a></li>
                              <li><a className={course.ct_color} href="#">{course.course_name}</a></li>
                           </ul>
                        </div>
                           ...
                           <ul className="d-flex align-items-center">
                              <li>
                                 <div className="rating-gold d-flex align-items-center">
                                    ...
                                    <span>({course.total_start})</span>
                                 </div>
                              </li>
                              <li><img src="/assets/img/icon/c-meta-01.png" alt="meta-icon" /> <span>{course.cls_text} Classes</span></li>
                              <li><img src="/assets/img/icon/c-meta-02.png" alt="meta-icon" /> <span>{course.st_text} Students</span></li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div className="cor-details-instructor mb-40">
                        ...
                        <div className="course-instructor-details d-flex f-wrap align-items-center">
                           <div className="course-avata mr-30 mb-20">
                              <img src={course.instructor.img} alt="avata-thumb" />
                           </div>
                           <div className="course-avatar-details mb-20">
                              <h5 className="c-avata-title mb-10">{course.instructor.name}</h5>
                              <p>{course.instructor.about}</p>
                              <div className="c-details-list mb-5">
                                 <ul className="d-flex align-items-center">
                                    <li>
                                       <div className="rating-gold d-flex align-items-center">
                                          <p>{course.instructor.start_text}</p>
                                          <i className="fi fi-ss-star"></i>
                                          <i className="fi fi-ss-star"></i>
                                          <i className="fi fi-ss-star"></i>
                                          <i className="fi fi-ss-star"></i>
                                          <i className="fi fi-rs-star"></i>
                                          <span>({course.instructor.total_st})</span>
                                       </div>
                                    </li>
                                    <li><img src="/assets/img/icon/c-details-01.png" alt="meta-icon" /><span>{course.instructor.cls_text} Classes</span></li>
                                 </ul>
                              </div>
                              <div className="c-details-stu">
                                 <ul>
                                    <li className="d-flex align-items-center"><img src="/assets/img/icon/c-details-02.png" alt="meta-icon"/> <span>{course.instructor.st_text} Students</span></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                        ...
                        <div className="course-reviewer-item-wrapper">
                              ...
                              {course.reviews.map((review, i) =>
                                 ...
                                 <div className="course-review-ava">
                                    <img src={review.img} alt="details-avata" />
                                 </div>
                                 <div className="course-review-content p-relative">
                                    <h5 className="course-ava-title mb-15">{review.name}</h5>
                                    <div className="tpcourse__rating-icon rating-gold d-flex align-items-center mb-10">
                                       <p>{review.rating}</p>
                                       <i className="fi fi-ss-star"></i>
                                       <i className="fi fi-ss-star"></i>
                                       <i className="fi fi-ss-star"></i>
                     ...
                     <div className="course-details-widget">
                        <div className="cd-video-price">
                           ...
                           <div className="cd-pricing-btn text-center mb-30">
                              <Link className="tp-vp-btn" href="/src/pages/course-details/[id]">Add To Cart</Link>
                              <Link className="tp-vp-btn-green" href="/src/pages/course-details/[id]">Enroll Now</Link>
                           </div>
                        </div>
                        <div className="cd-information mb-35">
                           <ul>
                              <li><i className="fa-light fa-calendars"></i> <label>Lesson</label> <span>{course.cls_text}</span></li>
                              <li><i className="fi fi-rr-chart-pie-alt"></i> <label>Quizess</label> <span>6</span></li>
                              <li><i className="fi fi-rr-user"></i> <label>Students</label> <span>{course.st_text}</span></li>
